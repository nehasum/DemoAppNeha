sap.ui.define([
	"sap/ui/test/Opa5",
	"D/DemoNehaApp/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("D.DemoNehaApp.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "empvals/" + encodeURIComponent(sObjectId);
